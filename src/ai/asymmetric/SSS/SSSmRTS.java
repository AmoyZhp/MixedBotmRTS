...
public class SSSmRTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public SSSmRTS(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
        ...
        buildPortfolio();
        System.out.println("constructur2");
    }
...
//        this.scripts.add(new StrategyTactics(utt));
//        this.scripts.add(new WorkerRush(utt));
// useable
//            this.scripts.add(new PuppetSearchMCTS(utt));
//                this.scripts.add(new NaiveMCTS(utt));
            
//            this.scripts.add(new NaiveMCTS(TIME, MAX_PLAYOUTS, PLAYOUT_TIME, 16, 0.33f, 0.0f, 0.4f, new RandomBiasedAI(), new SimpleSqrtEvaluationFunction3(), true));
        System.out.println("constructur3");
